...
export default function SettingsPage() {
  ...
  const [defaultTone,setDefTone]    = useState("Professional");
  const [senderName, setSenderName] = useState("Sam Okafor");
  const [signature,  setSignature]  = useState("Sam Okafor\nGrowth, Northwind\nnorthwind.io");
  const [notifs,     setNotifs]     = useState({ updates: true, recap: true, limit: false, tips: true });
    ...
    <>
      <header className="topbar">
        ...
        <div className="topbar-right">
          <button className="btn btn-ghost" style={{ fontSize: 14, padding: "10px 16px" }}>Discard</button>
      ...
      <div className="page" ref={scrollRef}>
        <div className="set-wrap">
          ...
          <nav className="set-nav">
            {SECTIONS.map((s, i) => (
              <a key={s} href={`#${SEC_IDS[i]}`} className={activeSec === SEC_IDS[i] ? "on" : ""} onClick={(e) => { e.preventDefault(); scrollTo(SEC_IDS[i]); }}>{s}</a>
            ))}
          </nav>
          ...
          <div>
            ...
            <section className="sect" id="plan">
              <div className="sect-head"><h2>Plan &amp; billing</h2>
            ...
            <section className="sect" id="defaults">
              ...
              <div className="frow">
                ...
                <input className="inp" type="text" value={senderName} onChange={(e) => setSenderName(e.target.value)} />
              </div>
              <div className="frow">
            ...
            <section className="sect danger" id="danger">
              ...
              <div className="danger-row" style={{ paddingBottom: 16, borderBottom: "1px solid var(--line-soft)", marginBottom: 16 }}>
                ...
                <button className="btn btn-ghost" style={{ fontSize: 13.5 }}><Download style={{ width: 15, height: 15 }} /> Export</button>
              </div>
